...
Please refer to [the workflow README](https://github.com/rhdhorchestrator/serverless-workflows/blob/v1.5.x/workflows/create-ocp-project/README.md#workflow-application-configuration)
