...
Please refer to [the workflow README](https://github.com/rhdhorchestrator/serverless-workflows/blob/v1.2.x/move2kube/README.md#workflow-application-configuration)
