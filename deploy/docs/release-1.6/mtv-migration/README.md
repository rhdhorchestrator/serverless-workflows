...
Please refer to [the workflow README](https://github.com/rhdhorchestrator/serverless-workflows/blob/v1.6.x/workflows/mtv-migration/README.md#workflow-application-configuration)
...
Note that if you run the `helm upgrade` command, the values of the secret are reset.
