...
Please refer to [the workflow README](https://github.com/rhdhorchestrator/serverless-workflows/blob/v1.5.x/workflows/request-vm-cnv/README.md#workflow-application-configuration)
