...
# Synopsis
This workflow invokes an application analysis workflow using [MTA][1]. You can continue to [move2kube][2] workflow after analysis is done if the analysis is considered to be successful.
...
[2]: https://github.com/rhdhorchestrator/serverless-workflows/tree/main/move2kube
